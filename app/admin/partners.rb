ActiveAdmin.register Partner do
  ...
  permit_params :brand, :mood, :daypart_1, :daypart_2, :deal, :status, :meal_size_1, :meal_size_2, :price, guide_ids: [],
                picture_attributes: [:id, :_destroy, :category, :image, :pictureable_id]
  ...
  form do |f|
    ...
    f.inputs do
      f.has_many :picture, allow_destroy: true do |a|
        a.input :pictureable, collection: Partner.where(id: params[:id]), include_blank: false, label: "Brand"
