...
partners = Partner.where(brand: ["Dos Toros", "Just Salad", "The Kati Roll Company", "The Little Beet"])
...
partners = Partner.where(brand: ["Carbone", "Mission Chinese", "Balthazar", "Pasquale Jones", "Russ & Daughters"])
...
partners = Partner.where(brand: ["Sweetberry Bowls" "Pure Green", "Juice Press"])
Guide.find_by_name("Because you don’t need the gym to keep lookin fly").partners << partners

partners = Partner.where(brand: ["Meatball Shop", "Poulet Sans Tete", "Maison Yaki"])
